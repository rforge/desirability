...
print(
#   wireframe(conversionPred ~ time + catalyst|temperature, plotGrid, drape = TRUE, colorkey = TRUE, 
#      zlab = list(expression("conversion"), rot = 90), 
#      zoom=0.8,    
#      col.regions =   colorRampPalette(brewer.pal(9, "Blues"))(100), as.table = TRUE,  screen = list(z = -30, x = -70, y = 0)))
...
print(
#   wireframe(activityPred ~ time + catalyst|temperature, plotGrid, drape = TRUE, colorkey = TRUE, 
#      zlab = list(expression("activity"), rot = 90), 
#      zoom=0.8,   
#      col.regions =   colorRampPalette(brewer.pal(9, "Blues"))(100), as.table = TRUE,  screen = list(z = -30, x = -70, y = 0)))
...
print(
#   wireframe(conversionDesire ~ time + catalyst|temperature, plotGrid, drape = TRUE, colorkey = TRUE, 
#      zlab = list(expression("d(conversion)"), rot = 90), 
#      zoom=0.8,
#      col.regions =   colorRampPalette(brewer.pal(9, "Blues"))(100),  as.table = TRUE,  screen = list(z = -30, x = -70, y = 0)))
...
print(
#   wireframe(activityDesire ~ time + catalyst|temperature, plotGrid, drape = TRUE, colorkey = TRUE, 
#      zlab = list(expression("d(activity)"), rot = 90), 
#      zoom=0.8,
#      col.regions =   colorRampPalette(brewer.pal(9, "Blues"))(100),  as.table = TRUE,  screen = list(z = -30, x = -70, y = 0)))
...
print(
#   wireframe(Overall ~ time + catalyst|temperature, plotGrid, drape = TRUE, colorkey = TRUE, 
#      zlab = list(expression("Desirability"), rot = 90), 
#      zoom=0.8,   
#      col.regions =   colorRampPalette(brewer.pal(9, "Blues"))(100),  as.table = TRUE,  screen = list(z = -30, x = -70, y = 0)))
